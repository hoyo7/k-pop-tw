...
const LandingPage = () => {
  ...
  const groups = [
    { name: 'SEVENTEEN', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Seventeen_Carat_Renewal_2022.png/500px-Seventeen_Carat_Renewal_2022.png', color: 'from-blue-200 to-pink-200', text: 'text-white' },
